<font color=red size=6>LATEST COMMIT FIXED A CRITICAL ERROR WHICH CAUSED POKEMON PREVIOUSLY SELECTED TO BE RELEASED UNDER CERTAIN CIRCUMSTANCES. PLEASE MAKE SURE YOUR REPO IS UP TO DATE</font>
